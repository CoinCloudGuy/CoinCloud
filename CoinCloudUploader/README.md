...
## How to use?
_The following text is also available as an image. See_ `HowToUse.png`_, in this folder or _ `CoinCloudBundle.png` _in the folder, that this folder is contained in._
